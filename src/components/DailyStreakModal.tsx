...
export function DailyStreakModal({ onRewardGranted }: Props) {
  const { open, setOpen, row, claim, loading, canClaimToday } = useDailyStreak();
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              {canClaimToday
                ...
                : `Best streak: ${row.best_streak} days`}
            </p>
          </div>
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-gradient-to-r from-primary to-accent text-primary-foreground font-bold disabled:opacity-50 disabled:cursor-not-allowed hover:scale-[1.02] active:scale-[0.98] transition-transform shadow-lg"
          >
